...
void main() {
    ...
    */
    ...
    float dx = mod(v_texCoords.x * u_inputSize.x * 2.0, 2.0);
    float dy = mod(v_texCoords.y * u_inputSize.y * 2.0, 2.0);
    ...
    // keep alone pixel
    if (d_5_9 * 2.0 < d_9_10 + d_5_10
    && d_5_11 * 2.0 < d_5_10 + d_10_11
    && d_9_15 * 2.0 < d_9_10 + d_10_15
    && d_11_15 * 2.0 < d_10_11 + d_10_15
    ) {
        gl_FragColor = p10;
        return;
    }
